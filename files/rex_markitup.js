    ...
    Plugin.prototype = {
        ...
        init: function () {                                                                                              //console.log('this.options:',this.options);
            ...
            if (this.options.smartinsert) {
                options.beforeInsert = $.proxy(function (h) {
                    this.beforeInsertCallback(h, this);
                }, this);
                options.afterInsert = $.proxy(function (h) {
                    this.afterInsertCallback(h, this);
                }, this);
            }
        ...
        parseURL: function (url) {                                                                                                               //console.group('parseUrl:',url);
